...
<img src="<?php echo base_url()?>imagenes1/<?php echo $_SESSION['foto'];?>" class="user-image" alt="User Image">
    ...
    <img src="<?php echo base_url()?>imagenes1/<?php echo $_SESSION['foto'];?>" class="user-image" alt="User Image">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url()?>index.php/general/cerrar" class="btn btn-default btn-flat">Salir</a>
                </div>
              </li>
            </ul>
...
<div class="user-panel">
   ...
   <img src="<?php echo base_url()?>imagenes1/<?php echo $_SESSION['foto'];?>" class="img-circle" style="width: 50px; height: 50px;" alt="User Image">  
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()?>index.php/usuarios/usuario"><i class="fa fa-circle-o"></i> Usuarios</a></li>
            <li><a href="<?php echo base_url()?>index.php/categorias/categoria"><i class="fa fa-circle-o"></i>Categoria</a></li>
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()?>index.php/productos/productos"><i class="fa fa-circle-o"></i>productos</a></li>            
          </ul>
      </li>
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()?>index.php/cliente/cliente"><i class="fa fa-circle-o"></i>cliente</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()?>index.php/ventas/ventas"><i class="fa fa-circle-o"></i>crear ventas</a></li>
            <li><a href="<?php echo base_url()?>index.php/reporte/index"><i class="fa fa-circle-o"></i> Reportes</a></li>
